...
<div class="container">
  ...
  <a class="col-lg-1" href='account.php?id=<?php echo $row['acc_id'];?>' style="text-decoration: none; background: ;" >
...
<div class="row">
      ...
      <div class="p-1 ps-sm-4 position-relative">
                ...
                <div class="card-body ps-lg-0">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <div class="p-0 pe-md-0 ">
                      <a href="close-account.php?id=<?php echo $row['id'];?>" style="text-decoration: none;">
