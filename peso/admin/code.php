...
$job_title_empty = array();  
$company_empty = array();  

$job_salary_empty = array();
$job_type_empty = array(); 
$job_schedule_empty = array(); 
$job_day_empty = array();    
$job_option_empty = array(); 
$job_category_empty = array(); 
$job_schedule_shift_empty = array(); 
$job_gender_empty = array(); 
$job_status_empty = array(); 
$posted_by_empty = array();  
$date_ended_empty = array();  
    
$job_description_empty = array();    
$job_requirements_empty = array();   
...
if(isset($_POST['add_job'])) {
        ...
        // CHECK IF NULL
        if ($job_title == null) {
            $job_title_empty['job_title'] = "This is required"; 
        }
            if ($company == null) {
                $company_empty['company'] = "This is required"; 
            }

            if ($job_salary == null) {
                $job_salary_empty['job_salary'] = "This is required";
            }

            if ($job_type == null) {
                $job_type_empty['job_type'] = "This is required"; 
            }

            if ($job_schedule == null) {
                $job_schedule_empty['job_schedule'] = "This is required"; 
            }

            if ($job_day == null) {
               $job_day_empty['job_day'] = "This is required";  
            }

            if ($job_option == null) {
                $job_option_empty['job_option'] = "This is required"; 
            }

            if ($job_category == null) {
                $job_category_empty['job_category'] = "This is required"; 
            }

            if ($job_schedule_shift == null) {
                $job_schedule_shift_empty['job_schedule_shift'] = "This is required"; 
            }

            if ($job_gender == null) {
                $job_gender_empty['job_gender'] = "This is required"; 
            }

            if ($job_status == null) {
                $job_status_empty['job_status'] = "This is required"; 
            }

            if ($posted_by == null) {
                $posted_by_empty['posted_by'] = "This is required";  
            }

            if ($date_ended == null) {
                $date_ended_empty['date_ended'] = "This is required";  
            }

            if ($job_description == null) {
                $job_description_empty['job_description'] = "This is required"; 
            }

            if ($job_requirements == null) {
                $job_requirements_empty['job_requirements'] = "This is required"; 
            }


            // CHECK IF NOT NULL
            if (count($job_title_empty) == 0) {
                if (count($job_salary_empty) == 0) {
                if (count($job_type_empty) == 0) {
                if (count($job_schedule_empty) == 0) {
                if (count($job_day_empty) == 0) {
                if (count($job_option_empty) == 0) {
                if (count($job_category_empty) == 0) {
                if (count($job_schedule_shift_empty) == 0) {
                if (count($job_gender_empty) == 0) {
                if (count($job_status_empty) == 0) {
                if (count($posted_by_empty) == 0) {
                if (count($date_ended_empty) == 0) {
                if (count($job_description_empty) == 0) {
                if (count($job_requirements_empty) == 0 ) {
...
<div class="container">
  ...
  <a class="col-lg-1" href='job.php' style="text-decoration: none; background: ;" onclick='return cancel()'>
          ...
          <div class="p-0 pe-md-0 ">
              ...
              <div id="view" >
               ...
               <?php  } else { ?>
                  ...
                  <div id="<?php echo $row['company']; ?>">
                      <img class="w-100 border-radius-md shadow-lg" src="../images/<?php echo $row['images']; ?>" alt='image'>
                  </div>
                      ...
                      <form  enctype="multipart/form-data" method="POST"> 
                        ...
                        <?php
                         ...
                         if (isset($_POST['add_job'])) {
                          ...
                          $_SESSION['job_option'] = $_POST['job_option'];
                          $_SESSION['job_category'] = $_POST['job_category'];
                          $_SESSION['job_day'] = $_POST['job_day'];
                          $_SESSION['job_schedule'] = $_POST['job_schedule'];
                          $_SESSION['job_schedule_shift'] = $_POST['job_schedule_shift'];
                          $_SESSION['job_gender'] = $_POST['job_gender'];
                          $_SESSION['job_salary'] = $_POST['job_salary'];
                        ...
                        <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item col-lg-2 col-12 col-md-12">
                                ...
                                <div class="form-label-group">
                                  <input type="text" style="color: black; font-size: 13PX;" name="job_title"  placeholder=" Enter job title" id="job_input" oninput="handleValueChange()"
                                         value="<?php echo isset($_SESSION['job_title']) ? $_SESSION['job_title'] : ''; ?>"
                                         class="form-control shadow-none">

                                   <?php if(count($job_title_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_title_empty as $showerror) { ?>
                              ...
                              <li class="nav-item ms-lg-1 col-lg-2 col-12 col-md-12">
                                ...
                                <div class="form-label-group">
                                  ...
                                  <select name="company" class="input-group shadow-none" id="company_select" oninput="handleValueChange()"
                                          ...
                                          <?php
                                            include '../database/database.php';
                                            $query = mysqli_query($con,"SELECT count(count) as company_count, status FROM company WHERE status = 'Active' order by id desc ");
                                            while($row = mysqli_fetch_array($query)){
                                          ?>

                                          <?php if ($row['company_count'] == 0) { ?>

                                          <option class="peso" style="color: black;" <?php echo isset($_SESSION['company']) == '' ? 'selected' : '' ; ?> > Empty company </option> 

                                          <?php } else { ?>

                                          <option class="peso" style="color: black;" <?php echo isset($_SESSION['company']) == '' ? 'selected' : '' ; ?> > Choose company </option> 
                                          ...
                                          <?php
                                            ...
                                            while($row = mysqli_fetch_array($query)){
                                          ?>
                                            <option class="peso_all" value="<?php echo $row['company']; ?>" <?php echo isset($_SESSION['company']) == $row['company'] ? 'selected' : '' ; ?>
                                                    style="color: black;"> <?php echo $row['company']; ?> </option>

                                          <?php } ?>

                                  </select>

                                   <?php if(count($company_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($company_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                          ...
                          <ul class="nav nav-pills nav-fill" style="background: none;">
                                ...
                                <li class="nav-item col-lg-2 col-12 col-md-12  mt-2 mt-2"> 
                                  <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Set up *
                                    <div class="form-label-group">
                                        ...
                                        <option style="color: black;" value="" <?php echo isset($_SESSION['job_type']) == '' ? 'selected' : '' ; ?>  > Choose set up </option> 
                                        <option value="On Site" <?php echo isset($_SESSION['job_type']) == 'On Site' ? 'selected' : '' ; ?>> On Site </option>
                                        <option value="Work From Home" <?php echo isset($_SESSION['job_type']) == 'Work From Home' ? 'selected' : '' ; ?>> Work Form Home </option>
                                      </select>

                                   <?php if(count($job_type_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_type_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                                ...
                                <li class="nav-item ms-lg-1 col-lg-2 col-12 col-md-12  mt-2">
                                  ...
                                  <div class="form-label-group">
                                      <select class="input-group shadow-none" type="int" name="job_option" id="flexible_input" oninput="handleValueChange()"
                                              style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option style="color: black;" value="" <?php echo isset($_SESSION['job_option']) == '' ? 'selected' : '' ; ?> > Choose Flexible Time </option> 
                                      ...
                                      ?>
                                       ...
                                       <option value="<?php echo $row['job_option'];?>" 
                                               <?php echo isset($_SESSION['job_option']) == $row['job_option'] ? 'selected' : '' ; ?>> <?php echo $row['job_option']; ?> </option>
                                       
                                      <?php } ?>

                                    </select>

                                  <?php if(count($job_option_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_option_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                                ...
                                <li class="nav-item ms-lg-1 col-lg-2 col-12 col-md-12  mt-2">
                                  ...
                                  <div class="form-label-group">
                                      <select class="input-group shadow-none" type="int" name="job_category" id="category_input" oninput="handleValueChange()"
                                              style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option style="color: black;" value="" <?php echo isset($_SESSION['job_category']) == '' ? 'selected' : '' ; ?> > Choose category </option> 
                                      ...
                                      ?>
                                       ...
                                       <option value="<?php echo $row['job_category'];?>" 
                                               <?php echo isset($_SESSION['job_category']) == $row['job_category'] ? 'selected' : '' ; ?>> <?php echo $row['job_category']; ?> </option>
                                       
                                      <?php } ?>

                                    </select>

                                   <?php if(count($job_category_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_category_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                          ...
                          <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item col-lg-3 col-12 col-md-12  mt-2">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Day *
                                  <div class="form-label-group">
                                      <select class="input-group shadow-none" type="int" name="job_day" id="day_input" oninput="handleValueChange()"
                                              style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option style="color: black;" value="" <?php echo isset($_SESSION['job_day']) == '' ? 'selected' : '' ; ?> > Choose day </option> 
                                      <option value="Monday to Friday" <?php echo isset($_SESSION['job_day']) == 'Monday to Friday' ? 'selected' : '' ; ?>>Monday to Friday</option>
                                      <option value="Monday to Saturday" <?php echo isset($_SESSION['job_day']) == 'Monday to Saturday' ? 'selected' : '' ; ?>>Monday to Saturday</option>
                                      <option value="Monday to Sunday / 1 Dayoff" <?php echo isset($_SESSION['job_day']) == 'Monday to Sunday / 1 Dayoff' ? 'selected' : '' ; ?>> Monday to Sunday / 1 Dayoff </option>
                                    </select>

                                   <?php if(count($job_day_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_day_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                              ...
                              <li class="nav-item ms-lg-1 col-lg-3 col-12 col-md-12  mt-2">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Hour *
                                  <div class="form-label-group">
                                      <select class="input-group shadow-none" type="int" name="job_schedule" id="time_input" oninput="handleValueChange()"
                                              style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option style="color: black;" value="" <?php echo isset($_SESSION['job_schedule']) == '' ? 'selected' : '' ; ?> > Choose Hour </option> 
                                      <option value="8 Hours Shift" <?php echo isset($_SESSION['job_schedule']) == '8 Hours Shift' ? 'selected' : '' ; ?>> 8 Hours Shift </option>
                                      <option value="12 Hours Shift" <?php echo isset($_SESSION['job_schedule']) == '12 Hours Shift' ? 'selected' : '' ; ?>> 12 Hours Shift </option>
                                      </select>

                                   <?php if(count($job_schedule_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_schedule_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                                ...
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Shift *
                                  <div class="form-label-group">
                                      <select class="input-group shadow-none" type="int" name="job_schedule_shift" id="shift_input" oninput="handleValueChange()"
                                              style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option style="color: black;" value="" <?php echo isset($_SESSION['job_schedule_shift']) == '' ? 'selected' : '' ; ?> > Choose shift </option> 
                                      <option value="Day Shift" <?php echo isset($_SESSION['job_schedule_shift']) == 'Day Shift' ? 'selected' : '' ; ?>>Day Shift</option>
                                      <option value="Night Shift" <?php echo isset($_SESSION['job_schedule_shift']) == 'Night Shift' ? 'selected' : '' ; ?>>Night Shift</option>
                                      <option value="Both" <?php echo isset($_SESSION['job_schedule_shift']) == 'Both' ? 'selected' : '' ; ?>>Both</option>
                                    </select>

                                   <?php if(count($job_schedule_shift_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_schedule_shift_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                          ...
                          <ul class="nav nav-pills nav-fill" style="background: none;">
                                ...
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Gender *
                                  <div class="form-label-group">
                                      <select class="input-group shadow-none" type="int" name="job_gender" id="gender_input" oninput="handleValueChange()"
                                              style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option style="color: black;" value="" <?php echo isset($_SESSION['job_gender']) == '' ? 'selected' : '' ; ?> > Choose gender </option> 
                                      <option value="Female" <?php echo isset($_SESSION['job_gender']) == 'Female' ? 'selected' : '' ; ?>>Female</option>
                                      <option value="Male" <?php echo isset($_SESSION['job_gender']) == 'Male' ? 'selected' : '' ; ?>>Male</option>
                                      <option value="Both" <?php echo isset($_SESSION['job_gender']) == 'Both' ? 'selected' : '' ; ?>>Both</option>
                                      </select>

                                   <?php if(count($job_gender_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_gender_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                              ...
                              <li class="nav-item ms-lg-1 col-lg-3 col-12 col-md-12  mt-2"></li>
                              <li class="nav-item ms-lg-1 col-lg-3 col-12 col-md-12  mt-2"></li>
                          </ul>
                          </div>
                              ...
                              <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Salary <span style="color: gray; font-size: 13px">(Optional)</span>
                                <div class="form-label-group">
                                    <select class="input-group shadow-none" type="int" name="job_salary" id="salary_input" oninput="handleValueChange()"
                                            style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                    <option style="color: black;" value="" <?php echo isset($_SESSION['job_salary']) == '' ? 'selected' : '' ; ?> > Choose salary </option> 
                                    <option value="Hide" <?php echo isset($_SESSION['job_salary']) == 'Hide' ? 'selected' : '' ; ?>> Hide Salary </option>
                                    <option value="PHP 10,100 - 15,000 Per Month" <?php echo isset($_SESSION['job_salary']) == 'PHP 10,100 - 15,000 Per Month' ? 'selected' : '' ; ?>>10,100 - 15,000 Per Month</option>
                                    <option value="PHP 15,100 - 20,000 Per Month" <?php echo isset($_SESSION['job_salary']) == 'PHP 15,100 - 20,000 Per Month' ? 'selected' : '' ; ?>>15,100 - 20,000 Per Month</option>
                                    <option value="PHP 20,100 - 25,000 Per Month" <?php echo isset($_SESSION['job_salary']) == 'PHP 20,100 - 25,000 Per Month' ? 'selected' : '' ; ?>>20,100 - 25,000 Per Month</option>
                                    <option value="PHP 25,100 - 30,000 Per Month" <?php echo isset($_SESSION['job_salary']) == 'PHP 25,100 - 30,000 Per Month' ? 'selected' : '' ; ?>>25,100 - 30,000 Per Month</option>
                                    <option value="PHP 35,100 - 40,000 Per Month" <?php echo isset($_SESSION['job_salary']) == 'PHP 35,100 - 40,000 Per Month' ? 'selected' : '' ; ?>>35,100 - 40,000 Per Month</option>
                                    <option value="PHP 45,100 - 50,000 Per Month" <?php echo isset($_SESSION['job_salary']) == 'PHP 45,100 - 50,000 Per Month' ? 'selected' : '' ; ?>>45,100 - 50,000 Per Month</option>
                                  </select>

                                   <?php if(count($job_salary_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_salary_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                          ...
                          <link rel="stylesheet" href="build/jodit.es2018.css">
                          <script src="build/jodit.es2018.js"></script>

                          <label class="mt-5" > Job Description and Qualifications </label>
                          <p class="form-label mt-2" style="color: black; text-align: left; font-size: 13PX;"> Description *</p>
                          <textarea name="job_description" placeholder="Type description" id="Qualifications"><?php echo isset($_SESSION['job_description']) ? $_SESSION['job_description'] : ''; ?></textarea>
                                
                                   <?php if(count($job_description_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_description_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                          ...
                          <script>
                           const editor = Jodit.make("#Qualifications");
                          </script>

                          <p class="form-label mt-5" style="color: black; text-align: left; font-size: 13PX;"> Requirements *</p>
                          <textarea name="job_requirements" placeholder="Type Requirements" id="Requirements"><?php echo isset($_SESSION['job_requirements']) ? $_SESSION['job_requirements'] : ''; ?></textarea>

                                   <?php if(count($job_requirements_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($job_requirements_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                          ...
                          <script>
                           const editor1 = Jodit.make("#Requirements");
                          </script>
                          ...
                          <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item col-lg-5 col-12 col-md-12  mt-2">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Date Ended *
                                  ...
                                  <input type="date" name="date_ended" id="date_filter" value="" class="form-control shadow-none" 
                                   ...
                                   <?php if(count($date_ended_empty) == 1) { ?>

                                      <span class="mt-2" style="color: red; font-size: 12px; float: left; background: none">
                                          <?php foreach ($date_ended_empty as $showerror) { ?>
                                               <i class="bi bi-exclamation-circle-fill"></i> <span class="ms-2"><?php echo $showerror; ?></span>
                                          <?php } ?>
                                      </span>
                            ...
                            <button type="submit" name="add_job" class="btn btn-success mt-3" style="color: white; font-size: 12px;" > SAVE </button>
...
$(document).ready(function() {
  ...
  $(document).on('change', '#company_select', function(){
      ...
      if ($('.peso').val('peso').prop('selected')) {
          $('#peso').removeAttr('hidden');
      } else {
          $('#peso').attr('hidden', 'hidden');
      }
  });
...
<div class="row">
    ...
    <div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 " style="border: 1px solid lightgray;">
        ...
        <div class="row">
                ...
                <div class="col-lg-2 col-md-12  mt-2 col-12 mt-3">
                <div class="p-0 pe-md-0 ">
                      <?php
                         if ($Company_profile == '') {
...
?>
                              ...
                              <li class="nav-item ms-lg-1 col-lg-3 col-12 col-md-12">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Time *
                                  <div class="form-label-group">
                                      ...
                                      <option value="7am to 3pm / 8 Hours Shift"> 7am to 3pm / 8 Hours Shift</option>
                                      <option value="8am to 5pm / 8 Hours Shift"> 8am to 5pm / 8 Hours Shift</option>
                                      <option value="9am to 6pm / 8 Hours Shift"> 9am to 6pm / 8 Hours Shift</option>
                                      <option value="10am to 7pm / 8 Hours Shift"> 10am to 7pm / 8 Hours Shift</option>
                                      <option value="6am to 6pm / 12 Hours Shift"> 6am to 6pm / 12 Hours Shift</option>
                                      <option value="6pm to 6am / 12 Hours Shift"> 6pm to 6am / 12 Hours Shift</option> 
                                      </select>
                                  </div>
                                </p>
                                </li>
                          ...
                          <label class="mt-3" > Job Description and Qualifications </label>
                          <p class="form-label mt-2" style="color: black; text-align: left; font-size: 13PX;"> Description *</p>
                          <textarea name="job_description" placeholder="Type description" id="Qualifications" required><?php echo $row['job_description'];?></textarea>
                          ...
                          <p class="form-label mt-4" style="color: black; text-align: left; font-size: 13PX;"> Requirements *</p>
                          <textarea name="job_requirements" placeholder="Type Requirements" id="Requirements" required><?php echo $row['job_requirements'];?></textarea>
