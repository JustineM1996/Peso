...
<div class="row">
  ...
  <a href='company-info.php?id=<?php echo $row['company_id'];?>' style="text-decoration: none; background: none ;" >
...
<a href="apply.php?id=<?php echo $row['id'];?>" class="btn btn-success" style="color: white; font-size: 12px;" onclick='return apply()'> APPLY NOW </a>
