...
<div class="row">
  ...
  <a href='job.php' style="text-decoration: none; background: none ;" >
...
<a href="account.php?JOBS=<?php echo $row['id'];?>" class="btn btn-success" style="color: white; font-size: 12px;" onclick='return apply()'> APPLY NOW </a>
