...
<head>
  ...
  <!-- TITLE -->
  <title> PESO - Peso Education </title>
  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> EDUCATION <p> | Add </p></h4>
        </div>
      </div>
    </div>
  </div>
...
<div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 ">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mx-auto">
          <h4 class="" style="color: black; "> Education  </h4>
        </div>
            ...
            <div class="p-0 pe-md-0">
                         ...
                         <input type="text" name="education_id" value="<?php echo $id_acc; ?>" hidden>
                         ...
                         <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Level of education
                                  <div class="form-label-group">
                                    <input type="text" style="color: black; font-size: 13PX;" name="Education" required
                                           class="form-control shadow-none" placeholder="Enter education" >
                                  </div>
                                </p>
                              </li>
                              ...
                              <li class="nav-item ms-lg-1 ms-1">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Field of study
                                  <div class="form-label-group">
                                    <input type="text" style="color: black; font-size: 13PX;" name="Field_Of_Study" required
                                           class="form-control shadow-none" placeholder="Enter field of study" >
                                  </div>
                                </p>
                              </li>                              

                              <li class="nav-item ms-lg-1 ms-1">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> School Name
                                  <div class="form-label-group">
                                    <input type="text" style="color: black; font-size: 13PX;" name="School_Name" required
                                           class="form-control shadow-none" placeholder="Enter school name">
                                  </div>
                                </p>
                              </li>
                          ...
                          <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item col-0 col-md-0 col-lg-0 mt-1">
                                  <div class="form-label-group">
                                    <input type="checkbox" name="currently_enrolled" id="currently_enrolled_add" style="color: black; font-size: 13PX;" onclick="enableCreateUser()">
                                  </div>
                              </li>
                          ...
                          <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item col-5 col-md-5 col-lg-5" id="close_to_month_add">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> To 
                                  <div class="form-label-group">
                                  <select type="int" name="School_From_To_Month" class="input-group shadow-none mt-2" id="to_month_add" required 
                                          style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" >
                                    <option value="" disabled selected hidden >Month</option>
                                    <option value="January" style="color: black;" >January </option>
                                    <option value="February" style="color: black;" >February </option>
                              ...
                              <li class="nav-item ms-lg-2 ms-2 col-5 col-md-5 col-lg-5" id="close_to_year_add">
                                <p class="form-label" style="color: white; text-align: left; font-size: 13PX; cursor: NOne;"> 2
                                  <div class="form-label-group">
                                  <select class="input-group shadow-none" type="int" name="School_From_To_Year" id="to_year_add" required 
                                            style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                                      <option value="" disabled selected hidden > Year </option>
                                  </select>
                                  </div>
                          ...
                          <button type="submit" name="add_education" class="btn btn-success mt-3" style="color: white; font-size: 12px;">SAVE</button>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('change', '#currently_enrolled_add', function(){
  ...
  $('#currently_enrolled_add').trigger('change');
  ...
  $('#to_month_add').val();
  $('#to_year_add').val();
  $("#currently_enrolled_add").click(function() {
...
<div class="container">
  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> EDUCATION <p> | Edit </p></h4>
        </div>
      </div>
    </div>
  </div>
...
$query = mysqli_query($con,"SELECT * FROM education WHERE edu_id = '$edit' ");
while($row = mysqli_fetch_array($query)) {
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mx-auto">
          <h4 class="" style="color: black; "> Education  </h4>
            ...
            <!-- FORM START -->
            <form action="add/education.php" method="GET" >

            <div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100">
            <div class="col-lg-12 col-md-12 col-12">
            <div class="p-0 pe-md-0">

                         <input type="text" name="edu_id" value="<?php echo $row['edu_id']?>" hidden>
                         ...
                         <ul class="nav nav-pills nav-fill" style="background: none;">
                              ...
                              <li class="nav-item">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Level of education
                                  <div class="form-label-group">
                                    <input type="text" style="color: black; font-size: 13PX;"  value="<?php echo $row['Education'];?>" required
                                           name="Education"  class="form-control shadow-none" placeholder="Enter education" >
                                  </div>
                                </p>
                              </li>
                              ...
                              <li class="nav-item ms-lg-1 ms-1">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Field of study
                                  <div class="form-label-group">
                                    <input type="text" style="color: black; font-size: 13PX;"  value="<?php echo $row['Field_Of_Study'];?>" required
                                           name="Field_Of_Study"  class="form-control shadow-none" placeholder="Enter field of study" >
                                  </div>
                                </p>
                              </li>                              
                              ...
                              <li class="nav-item ms-lg-1 ms-1">
                                <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> School Name
                                  <div class="form-label-group">
                                    <input type="text" style="color: black; font-size: 13PX;"  value="<?php echo $row['School_Name'];?>" required
                                           name="School_Name"  class="form-control shadow-none" placeholder="Enter school name">
                                  </div>
                                </p>
                              </li>
                          ...
                          <button type="submit" name="edit_education" class="btn btn-success mt-3" style="color: white; font-size: 12px;">SAVE</button>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('change', '#currently_enrolled_edit', function(){
  ...
  $('#currently_enrolled_edit').trigger('change');
