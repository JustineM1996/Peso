...
$fileName = $_FILES["Resume"]["name"]; // The file name
$fileTmpLoc = $_FILES["Resume"]["tmp_name"]; // File in the PHP tmp folder
$fileSize = $_FILES["Resume"]["size"]; // File size in bytes
    ...
    if($fileSize) {
       ...
       $allowed_ext = array('PDF', 'pdf');
        ...
        if (in_array($end, $allowed_ext)) {
            $code = rand(999, 111);
            $db_filename_resume = $F_acc."_".$M_acc."_".$L_acc."_".'resume'."_".$code.".".$end;
            $filename_resume = '../files/'.$F_acc."_".$M_acc."_".$L_acc."_".'resume'."_".$code.".".$end;
            
            if(move_uploaded_file($fileTmpLoc, $filename_resume)) {
    
                mysqli_query($con, "INSERT INTO resume (Resume, resume_id) 
                                                VALUES ('$db_filename_resume', '$resume_id')");

                    echo "<script>alert('Successfull upload personal resume')</script>";
       ...
       $allowed_ext = array('PDF', 'pdf');
        ...
        if (in_array($end, $allowed_ext)) {
            ...
            if(move_uploaded_file($fileTmpLoc, $filename_resume)) {
                ...
                $query = mysqli_query($con,"SELECT * FROM resume WHERE res_id = '$res_id'");
                while($row = mysqli_fetch_assoc($query)) {

                $file = '../files/'.$row['Resume'];;
                ...
                mysqli_query($con, "UPDATE resume SET res_id = '$res_id',
                                                      Resume = '$db_filename_resume'
                                                      WHERE res_id = '$res_id' ");

                    echo "<script>alert('Successfull update personal resume')</script>";
                    echo "<script>window.location = '/peso/user/personal-resume-view.php'</script>"; 
                }
...
$delete = $_GET['delete'];
    ...
    $query = mysqli_query($con,"SELECT * FROM resume WHERE res_id = '$delete'");
    while($row = mysqli_fetch_assoc($query)) {
    ...
    mysqli_query($con,"DELETE FROM resume WHERE res_id = '$delete'");

    echo "<script>alert('Successfull delete resume')</script>";
    echo "<script>window.location = '/peso/user/personal-resume-view.php'</script>"; 
  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> PERSONAL <p> | Upload </p> </h4>
        </div>
      </div>
    </div>
  </div>
...
<div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 ">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mx-auto">
          <h4 class="ms-2" style="color: black;"> Personal Resume  </h4>
        </div>
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <input type="int" name="resume_id" value="<?php echo $row['id'];?>" hidden>
                <input type="file" name="Resume" id="upload" accept=".pdf" hidden >
                ...
                <script type="text/javascript">
                 ...
                 <style type="text/css">
                  ...
                  <input type="submit" name="add_resume" id="submit" value="UPLOAD" class="btn btn-success mt-4" style="box-shadow: none; color: white; font-size: 12px;" disabled> 
...
<div class="container">
  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> PERSONAL <p> | Update </p> </h4>
        </div>
      </div>
    </div>
  </div>
...
$query = mysqli_query($con,"SELECT * FROM resume WHERE res_id = '$edit' ");
while($row = mysqli_fetch_array($query)) {
...
<div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 ">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mx-auto">
          <h4 class="" style="color: black; "> Personal Resume  </h4>
        </div>
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <input  type="file" name="Resume" id="upload" value="<?php echo $row['Resume'];?>" class="file" accept=".pdf" hidden >
                ...
                <div style="float: right;">
                 ...
                 <style type="text/css">
                  ...
                  <input type="submit" name="edit_resume" id="submit" value="UPDATE" class="btn btn-success mt-4" style="box-shadow: none; color: white; font-size: 12px;" disabled> 
