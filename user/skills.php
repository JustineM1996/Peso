  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> SKILL <p> | Add </p></h4>
        </div>
      </div>
    </div>
  </div>
...
<div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 ">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mx-auto">
          <h4 class="" style="color: black; "> Skill  </h4>
        </div>

        <!-- FORM START -->
        <form action="add/skills.php" method="POST" enctype="multipart/form-data">
            ...
            <ul class="nav nav-pills nav-fill" style="background: none;">
                ...
                <li class="nav-item col-lg-12">
                  <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Skill Name
                    <div class="form-label-group">
                    <input type="int" name="skill_id" value="<?php echo $row['id'];?>" hidden>
                    <input type="text" name="skill_name" placeholder="Enter skill name" class="form-control shadow-none" required
                           style="font-size: 13px; color: black; font-weight: normal;">
                    </div>
                  </p>
                </li>
            ...
            <ul class="nav nav-pills nav-fill" style="background: none;">
                ...
                <li class="nav-item">
                  <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Year of Experience 
                    <div class="form-label-group">
                    <select class="input-group shadow-none" type="text" name="year_of_experience" required 
                            style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                      <option value="" disabled selected hidden >Year of Experience </option>
                      <option value="Less than 1 year" style="color: black;" > Less than 1 year </option>
                      <option value="1 year" style="color: black;" >1 year </option>
                      <option value="2 years" style="color: black;" >2 years </option>
                      <option value="3 years" style="color: black;" >3 years </option>
                      <option value="4 years" style="color: black;" >4 years </option>
                      <option value="5 years" style="color: black;" >5 years </option>
                      <option value="6 years" style="color: black;" >6 years </option>
                      <option value="7 years" style="color: black;" >7 years </option>
                      <option value="8 years" style="color: black;" >8 years </option>
                      <option value="9 years" style="color: black;" >9 years </option>
                      <option value="10 + years" style="color: black;" >10 + years </option>
                    </select>
                  </p>
                </li>
            ...
            <button type="submit" name="add_skill" class="btn btn-success mt-4" style="color: white; font-size: 12px;" > SAVE </button>
...
<div class="container">
  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> SKILL <p> | Edit </p></h4>
        </div>
      </div>
    </div>
  </div>
...
$query = mysqli_query($con,"SELECT * FROM skills WHERE sk_id = '$edit' ");
while($row = mysqli_fetch_array($query)) {
...
<div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 ">
    ...
    <div class="row">
        ...
        <!-- FORM START -->
        <form action="add/skills.php" method="GET" enctype="multipart/form-data">
            ...
            <ul class="nav nav-pills nav-fill" style="background: none;">
                ...
                <li class="nav-item">
                  <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Skill Name
                    <div class="form-label-group">
                    <input type="int" name="sk_id" value="<?php echo $row['sk_id'];?>" hidden>
                    <input type="text" name="skill_name" value="<?php echo $row['skill_name'];?>" required
                           placeholder="Enter skill name" class="form-control shadow-none"
                           style="font-size: 13px; color: black; font-weight: normal;">
                    </div>
                  </p>
                </li>
            ...
            <ul class="nav nav-pills nav-fill" style="background: none;">
                ...
                <li class="nav-item col-12 col-md-12 col-lg-12">
                  <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Year of Experience 
                    ...
                    <select class="input-group shadow-none" type="text" name="year_of_experience" required 
                            style="color: black; font-size: 13PX; border-radius: 3px; border: 1px solid lightgray; padding: 6px;" > 
                      <option value="<?php echo $row['year_of_experience']; ?>" hidden ><?php echo $row['year_of_experience']; ?></option>
                      <option value="Less than 1 year" style="color: black;" > Less than 1 year </option>
                      <option value="1 year" style="color: black;" >1 year </option>
                      <option value="2 years" style="color: black;" >2 years </option>
                      <option value="3 years" style="color: black;" >3 years </option>
            ...
            <button type="submit" name="edit_skill" class="btn btn-success mt-4" style="color: white; font-size: 12px;" > SAVE </button>
