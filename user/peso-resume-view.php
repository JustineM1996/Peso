...
<div class="container">
  ...
  <a class="col-lg-1" href='account.php?JOBS=<?php echo $job_id;?>' style="text-decoration: none; background: none ;" onclick='return apply()'>
...
<div class="container">
  ...
  <a class="col-lg-1" href='account.php?id=<?php echo $row['id'];?>' style="text-decoration: none; background: none ;" >
