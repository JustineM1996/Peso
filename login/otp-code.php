    ...
    if ($code_res) {
        ...
        if ($data_check) {
            ...
            if (mail($email, $subject, $message, $sender)) {
                ...
                echo "<script>window.location = 'otp-code.php'</script>";
                exit();
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom" style="background: none; border: none; box-shadow: none;">
            ...
            <form action="otp-code.php" method="POST" autocomplete="" class="auth-form login-form mt-5">
              ...
              <script>
                ...
                <div class="mt-3">
                <button type="submit" name="check" class="btn btn-success" style="font-size: 12px"> Submit </button>

                <div style="float: right; text-align: right;">
                  <a href='otp-code.php?reset=<?php echo $email;?>' onclick='return deletee()' class="text-secondary ../assets/icon-move-right" style="text-decoration: none;" > 
