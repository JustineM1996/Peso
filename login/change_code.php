...
if (isset($_POST['submit'])) {
        ...
        $change_code = mysqli_real_escape_string($con, $_POST['change_code']);
        $check_code = "SELECT * FROM account WHERE change_code = '$change_code'  ";
        ...
        if (mysqli_num_rows($code_res) > 0) {
            ...
            $fetch_code = $fetch_data['change_code'];
            $email = $fetch_data['email'];
            $change_code = 0;
            $update_otp = "UPDATE account SET change_code = '$change_code' WHERE change_code = $fetch_code";
...
$email = $_REQUEST['reset'];
    ...
    if ($code_res) {
        ...
        $update_data = "UPDATE account SET change_code = '$change_code' WHERE email = '$email' ";
        ...
        if ($data_check) {
            ...
            if (mail($email, $subject, $message, $sender)) {
                ...
                $info = "We've sent a verification code to your email - $change_code";
                $_SESSION['info'] = $info;
                $_SESSION['email'] = $email;
                $_SESSION['password'] = $password;
        ...
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom" style="background: none; border: none; box-shadow: none;">
            ...
            <div class="card-body">
                    ...
                    <h3 class=""> P E S O </h3>
                    <h4 class="mt-3">Change email OTP Verification </h4>

            <form action="change_code.php" method="POST" autocomplete="" class="auth-form login-form mt-5">
                    ...
                    <div style="margin-top: 5%">
                        ...
                        <p class="form-label" style="color: black; text-align: left; font-size: 13PX;"> Enter OTP sent to your email. 
                            <div class="form-label-group">
                              <input type="tel" name="change_code" class="form-control shadow-none" maxlength="6" placeholder="Enter 6 digit OTP" 
                                     ...
                                     <span id="timer" style="color: black; text-align: left; font-size: 13PX; float: right;">
                                          <a href='login-verify.php?reset=<?php echo $email;?>' class="text-secondary icon-move-right" style="text-decoration: none;" > 
                        ...
                        <div style="float: right; text-align: right;">
                          <a href='../index.php' onclick='return deletee()' class="text-secondary icon-move-right" style="text-decoration: none;" > 
