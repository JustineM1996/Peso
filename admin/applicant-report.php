...
<?php
   ...
   $query =  "SELECT company.id,
                     ...
                     WHERE applicant.Date_Posted BETWEEN '$startdate' AND '$enddate' order by applicant.id desc";
...
<?php
   ...
   $count_query =  "SELECT
                     ...
                     JOIN job ON job.company_id = company.id
                     JOIN applicant ON applicant.company_id = company.id and applicant.job_id = job.id
                     WHERE applicant.Date_Posted BETWEEN '$startdate' AND '$enddate' ";
...
<div class="container">
  ...
  <a class="col-lg-1" href='applicant-all.php' style="text-decoration: none; background: none ;" onclick='return apply()'>
    <i class='fas fa-angle-left' style="font-size: 15px; color: black; border-radius: 100%; padding: 10px 15px; transition: 0.3s;"></i>
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> APPLICANT <p> | Reports </p></h4>
        </div>
      </div>
    </div>
  </div>
...
<tr style="background-color: whitesmoke;">
  ...
  <td colspan="2" style="background: whitesmoke; color: black; font-weight: 500">
                   Total Jobs - <?php echo $total_jobs ;?> 
                   Active - <?php echo $total_new_job ;?> 
                   Inactive - <?php echo $total_end_job ;?> 
                   Succsessfull - <?php echo $total_suc_job ;?> 
  </td>
