  ...
  <script type="text/javascript">
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> ACCOUNT <p> | Delete account verification </p></h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="info-horizontal border-radius-xl d-block d-block d-md-flex p-4 h-100 ">
        ...
        <input type="email" name="email" value="<?php echo $row['email']; ?>" hidden>
            ...
            <h6 style="font-size: 14px; color: black; font-weight: normal;"  class="mt-2"> 
             Updating this email will only change where you receive these notifications, not which notifications you receive.
            </h6>
            <h6 class="mt-3" style="font-size: 14px; color: black; font-weight: normal;"><span style="font-weight: 500;"> Account Delete Required </span><br><br>
                  1. <span style="font-weight: 500;"> EXAMPLE </span> : The password has to meet all the requirements.<br>
                  Using the metrics above, we are going to create a strong level password that has at least one lowercase letter, one uppercase letter, one digit, one special character, and is at least fourteen characters long.<br><br>

                  2. <span style="font-weight: 500;"> EXAMPLE </span> : If the password is at least twelve characters long and meets all the other requirements, or has no digit but meets the rest of the requirements.<br>
                  ...
                  3. <span style="font-weight: 500;"> EXAMPLE </span> : If the password entered does not meet the strong or medium-level requirements, then it is deemed weak.<br><br>

                  4. Use 8 or more characters you can use letters, number & periods. Example(Sample12@gmail.com).<br><br>
                  5. Current email account are not allowed to set new email account.<br><br>

                  <input type="checkbox" id="checking" name="checking" required="true" disabled 
                         style="color: black; font-size: 13PX; border-radius: 3px; padding: 6px 15px;" 
                         class="mt-2 checking"> <span class="ms-2" style="font-weight: 500;"> Agree </span> :.<br><br>
            </h6>
            </h6>
            </div>
            </div>
