...
<head>
  ...
  <!-- LOGO -->
  <link rel="shortcut ../assets/" type="image/png" href="../images/LOGO.png">
...
<div class="card card-profile col-lg-12 col-md-12 col-12 my-auto mt-3"
    ...
    <div class="row">
              ...
              <div class="card-body pe-md ps-lg-0">
                ...
                <div class="app-card-actions mt-1" >
                  <div class="dropdown" style="float: right; text-align: center;">
                    <div class="dropdown-toggle no-toggle-arrow btn btn-secondary" data-bs-toggle="dropdown" aria-expanded="false" style="box-shadow: none"><?php include '../assets/icon/three_dot.php'?></div>
                  ...
                  <script>
                    ...
                    if ($job_status == 'Inactive' and $date_ended >= $date) {

                      echo "<td style='text-align: center;'> <span class='ms-2' style='background: darkgreen; color: white; padding: 3Px 8px; border-radius: 5px; text-decoration: none; font-size: 10px'> Start job </span></td>";

                    } else if ($job_status == 'Inactive' and $date_ended == '0000-00-00') {

                      echo "<td style='text-align: center;'> <span class='ms-2' style='background: darkred; color: white; padding: 3Px 8px; border-radius: 5px; text-decoration: none; font-size: 10px'> End job </span></td>";
