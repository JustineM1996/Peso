...
<head>
  ...
  <!-- TITLE -->
  <title> PESO - All Jobs Reports </title>
...
<?php
    ...
    if ($startdate == "" || $enddate == "") { 
          ...
          $query =  "SELECT company.id,
                     ...
                     WHERE job.date_posted BETWEEN '$startdate' AND '$enddate' group BY job.id order by job.id desc  ";
          ...
          $query =  "SELECT company.id,
                     ...
                     FROM company 
                     JOIN job ON job.company_id = company.id
                     LEFT JOIN applicant ON applicant.company_id = company.id and applicant.job_id = job.id  group BY job.id order by job.id desc ";
                     $searchResult = date_time($query);
    }
...
<?php
  ...
  if ($startdate == "" || $enddate == "") { 
   ...
   $count_query =  "SELECT
                     ...
                     JOIN job ON job.company_id = company.id
                     LEFT JOIN applicant ON applicant.company_id = company.id and applicant.job_id = job.id
                     WHERE job.date_posted BETWEEN '$startdate' AND '$enddate' ";
...
<?php
  ...
  $count_job_query = "SELECT company.id,
                       ...
                       FROM company 
                       JOIN job ON job.company_id = company.id
                       WHERE job.date_posted BETWEEN '$startdate' AND '$enddate' order by job.id desc";
...
<div class="container">
  ...
  <a class="col-lg-1" href='job.php' style="text-decoration: none; background: none ;" onclick='return apply()'>
    <i class='fas fa-angle-left' style="font-size: 15px; color: black; border-radius: 100%; padding: 10px 15px; transition: 0.3s;"></i>
      ...
      <div class="row my-sm-3">
        <div class="col-lg-12 mx-auto">
          <h4 class="mb-0" style="color: black;"> ALL JOBS <p> | Records </p></h4>
        </div>
      </div>
    </div>
  </div>
...
$date_posted = date("F d, Y", strtotime ($row['job_date_posted']));
    ...
    <tr>
      ...
      <td><?php echo $row['job_title'];?>
          ...
          if ($job_status == 'Active' and $date_ended >= $date) {
            ...
            echo "<span style='background: darkgreen; color: white; padding: 3Px 8px; border-radius: 5px'> $job_status </span>";

          } else if ($job_status == 'Inactive' and $date_ended == '0000-00-00') {

            echo "<span style='background: darkred; color: white; padding: 3Px 8px; border-radius: 5px'> $job_status </span>";

          } else if ($job_status == 'Active' and $date_ended <= $date)  {

            echo "<span style='background: darkblue; color: white; padding: 3Px 8px; border-radius: 5px'> Successfull </span>";
      ...
      <td style='text-align: center;'><?php echo $date_posted;?></td>

          <?php

          $end_job = date("F d, Y", strtotime ($row['end_job']));
          $date = date("F d, Y", strtotime ($row['job_date_ended']));
          $date_ended = $row['job_date_ended'];

          if ($date_ended == '0000-00-00') {

             echo "<td style='text-align: center;'> End job - $end_job </td>";
      ...
      <td colspan="1" style="background: lightgray; color: black;" >Applicant - <?php echo $row['applicant_count'];?> | Male - <?php echo $row['male'];?> | Female - <?php echo $row['female'];?></td>
      <td colspan="1" style="background: whitesmoke; color: black;">New - <?php echo $row['applicant_new'];?> | Male - <?php echo $row['new_male'];?> | Female - <?php echo $row['new_female'];?> </td>
      <td colspan="1" style="background: lightgray; color: black;">Pull - <?php echo $row['applicant_pulled'];?> | Male - <?php echo $row['pulled_male'];?> | Female - <?php echo $row['pulled_female'];?> </td>
      <td colspan="1" style="background: whitesmoke; color: black;">Reject - <?php echo $row['applicant_reject'];?> | Male - <?php echo $row['reject_male'];?> | Female - <?php echo $row['reject_male'];?></td>
      <td colspan="1" style="background: lightgray; color: black;">Hide - <?php echo $row['applicant_hide'];?> | Male - <?php echo $row['hide_male'];?> | Female - <?php echo $row['hide_male'];?></td>
...
?>
  ...
  <td colspan="1" style="background: lightgray; color: black; font-weight: 500"> Total Applicant - <?php echo $applicant_count ;?> | Male - <?php echo $gender_male ;?> | Female - <?php echo $gender_female ;?></td>
  <td colspan="1" style="background: whitesmoke; color: black; font-weight: 500"> Total New - <?php echo $new ;?> | Male - <?php echo $new_male ;?> | Female - <?php echo $new_female ;?></td>
  <td colspan="1" style="background: lightgray; color: black; font-weight: 500"> Total Pulled - <?php echo $pulled ;?> | Male - <?php echo $pulled_male ;?> | Female - <?php echo $pulled_female ;?></td>
  <td colspan="1" style="background: whitesmoke; color: black; font-weight: 500"> Total Reject - <?php echo $reject ;?> | Male - <?php echo $reject_male ;?> | Female - <?php echo $reject_female ;?></td>
  <td colspan="1" style="background: lightgray; color: black; font-weight: 500"> Total Hide - <?php echo $hide ;?> | Male - <?php echo $hide_male ;?> | Female - <?php echo $hide_female ;?></td>
