...
<link rel="apple-touch-../assets/icon" sizes="76x76" href="assets/img/apple-../assets/icon.png">
...
<!--     Fonts and ../assets/icons     -->
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700" />

<!-- Nucleo ../assets/icons -->
<link href="assets/css/nucleo-../assets/icons.css" rel="stylesheet" />
<link href="assets/css/nucleo-svg.css" rel="stylesheet" />

<!-- Font Awesome ../assets/icons -->
<script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>

<!-- Material ../assets/icons -->
<link href="https://fonts.googleapis.com/../assets/icon?family=Material+../assets/icons+Round" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-fixed shadow-none position-absolute my-3 py-2 start-0 end-0 mx-4" 
    ...
    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
      <ul class="navbar-nav navbar-nav-hover ms-auto">
          ...
          <li class="nav-item ms-lg-auto mt-3">
              <a href="login/login.php" class="btn-primary nav-link ps-2 d-flex cursor-pointer align-items-center ms-2 mt-0" style="border-radius: 5px; padding: 5px 8px;" >
