...
job_status = 'Active' and date_ended >= '$date' order by job.id desc limit 12");
                      ...
                      <div class="card-body p-0 pe-md ps-lg-4">
                        <a href="image-zoom.php?id=<?php echo $row['id'] ?>"> 
                          ...
                          <?php if ($row['image'] == '') { ?>
                            ...
                            <img class="ceo_image w-100 border-radius-md shadow-lg" src='images/<?php echo $row['image'] ;?>' alt='image'>
...
<?php } ?>
  ...
  $query = mysqli_query($con,"SELECT count(count) as post_count, date_ended, image_status FROM image WHERE image_status = 'Active' and date_ended >= '$date'  order by id desc limit 1 ");
  ...
  <?php } else { ?>  
    ...
    <div class="mt-3">
      <a href="announcement.php" style="text-decoration: none;" class="text-secondary ../assets/icon-move-right"> 
...
<?php
  ...
  $query = mysqli_query($con,"SELECT company.id as com_id,
                                     ...
                                     WHERE company.Status = 'Active' GROUP BY company.id order by company.id desc limit 6" );  
...
<?php } ?>
  ...
  date_default_timezone_set('Asia/Manila');
  $date = date('Y-m-d');
  $query = mysqli_query($con,"SELECT count(count) as company_count, status FROM company WHERE status = 'Active' order by id desc limit 1 ");
  ...
  <?php } else { ?>  
    ...
    <div class="mt-3">
      <a href="company.php" style="text-decoration: none;" class="text-secondary ../assets/icon-move-right"> 
      ...
      <div class="col-lg-6 ms-auto">
        ...
        <!-- END -->
          ...
          <a href="#" style="text-decoration: none;" 
             class="text-secondary ../assets/icon-move-right "> 
...
<!-- START -->
<div class="col-md-3.5 mx-auto mt-6">
